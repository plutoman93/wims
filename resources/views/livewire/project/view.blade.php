          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">{{$title_name}}   {{$first_name}} {{$last_name}}</h3>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <strong><i class="fas fa-book mr-1"></i> เบอร์มือถือ</strong>
                ...
                <strong><i class="fas fa-map-marker-alt mr-1"></i> คณะ</strong>

                <p class="text-muted">{{$faculty_name}}</p>

                <hr>

                <strong><i class="fas fa-pencil-alt mr-1"></i> อีเมลล์</strong>
